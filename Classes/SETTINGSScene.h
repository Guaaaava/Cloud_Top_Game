...
private:
	...
	Sprite* ProgressTimer;                  //创建时间进度条
	Sprite* Lable;                          //创建时间标签
	Sprite* progress;                       //创建时间进度条
	Sprite* countdownCallback;              //创建倒计时
	Sprite* CountdownSprite;                //创建倒计时进度条
...
private:
	...
	//Sprite* creatProgressTimer(Vec2 pos);                                                   //创建倒计时

	Sprite* createCountdownSprite(Vec2 pos);                                            //创建倒计时进度条        

	//Sprite* creatLable(Vec2 pos);                                                           //创建倒计时的时间标签
